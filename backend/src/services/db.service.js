...
class DbService {
  ...
  async getSchemaContent(profileId, schema, isShowTable, isTarget, oidArr, userId) {
    return await DbRepository.getSchemaContent(profileId, schema, isShowTable, isTarget, oidArr, userId);
  }
  async getSchemaTree(profileId, rootId, dbOid, userId, typeLevel) {
    return await DbRepository.getSchemaTree(profileId, rootId, dbOid, userId, typeLevel);
  }
  async getSchemaContentTree(profileId, baseRootIdOid, dbOid, userId, typeLevel) {
