export function loadExComponentMonacoEditor() {
  webix.protoUI(
    {
      name: "monaco-editor",
      defaults: {
      ...
      _render_editor: function () {
        ...
        var cdn =
          this.config.cdn || "http://localhost:9000/assets/monaco-editor/";

        webix
          .require(cdn + "vs/loader.js")
          .then(
            webix.bind(function () {
      ...
      _render_when_ready: function () {
        ...
        if (this._focus_await) this._editor.focus();
      },
