  ...
  return {
    ...
    head: {
      ...
      cols: [
        ...
        {
          template: winLabel,
          css: "z-window-header webix_view webix_header webix_win_title",
          borderless: true,
        },
        { width: 30 },
      ],
            ...
            onAfterValidation: function (result, value) {
              if (!result) {
                ...
                for (var key in value) {
                  if (key == "username") text.push("Username can't be empty");
                  if (key == "fullname") text.push("Fullname can't be empty");
                  if (key == "user_level") text.push("Role can't be empty");
                }
...
const remove = () => {
  ...
  if (item.username == "admin") {
    return webix.message({
      text: `Ops, <strong>admin</strong> user can not delete.`,
      type: "error",
    });
  }
