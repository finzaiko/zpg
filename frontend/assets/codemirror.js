webix.protoUI(
  {
    ...
    defaults: {
      ...
      // monokai
      // yonce
      cdn: "node_modules/codemirror",
    },
    $init: function (config) {
      this.$view.innerHTML =
        "<textarea style='width:100%;height:100%;' id='z_query_editor'></textarea>";
    ...
    _render_cm_editor: function () {
      ...
      // var cdn = this.config.cdn || "node_modules/codemirror/lib";
      // basic
      // /home/finzaiko/Projects/postgres/zpgtool/public/node_modules/codemirror/addon
      ...
      var sources = [
        ...
        cdn + "/addon/search/search.js",
        cdn + "/addon/search/searchcursor.js",
        cdn + "/addon/search/jump-to-line.js",
        cdn + "/addon/dialog/dialog.js",
        cdn + "/addon/dialog/dialog.css",
      ];
    ...
    setValue: function (value) {
      ...
      if (this._editor) {
        ...
        if (!this.config.preserveUndoHistory) this._editor.clearHistory();
        this._updateScrollSize();
      }
    },
    getValue: function () {
